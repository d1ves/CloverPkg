...
#define	XHCI_CMD_LHCRST	                   BIT7	/* RO/RW Light Host Controller Reset */
#define	XHCI_CMD_CSS	                   BIT8	/* RW Controller Save State */
#define	XHCI_CMD_CRS	                   BIT9	/* RW Controller Restore State */
...
#define	XHCI_PS_WCE		                     BIT25	/* RW - wake on connect enable */
#define	XHCI_PS_WDE		                     BIT26	/* RW - wake on disconnect enable */
#define	XHCI_PS_WOE		                     BIT27	/* RW - wake on over-current enable */
